...
local function GetURL(scripturl, usedir)
	if shared.VapeDeveloper or usedir then
		return readfile("vape/"..scripturl)
	else
		return game:HttpGet("https://raw.githubusercontent.com/alphatristan2/iH64U4yw8JRZME9a59HqkQ96uDSzSP/main/"..scripturl, true)
	end
end
...
pcall(function()
	-- whitelisted = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/alphatristan2/white-9955tVcos9sPsdtFdojTnxNF5Q3RAX/main/whitelist2.json", true))
	whitelisted = game:GetService("HttpService"):JSONDecode(GetURL("whitelist2.json"))
end)
